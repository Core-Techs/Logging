...
namespace CoreTechs.Logging
{
    ...
    internal static class TryTo
    {
        ...
        {
            readonly private Lazy<TimeSpan> _lazyDuration;
        ...
        public static class Repeatedly
        {
            ...
            {
                while (true) yield return new Lazy<Attempt>(() => TryTo.Do(action));
            }
            ...
            {
                while (true) yield return new Lazy<Attempt<T>>(() => TryTo.Get(factory, @default));
            }
        }
        ...
        public static IEnumerable<T> DelayWhere<T>(this IEnumerable<T> source, Func<T, bool> predicate, TimeSpan delay,
            Func<TimeSpan, TimeSpan> delayAdjustment = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public static IEnumerable<Lazy<T>> DelayWhereFailed<T>(this IEnumerable<Lazy<T>> lazyAttempts, TimeSpan delay, Func<TimeSpan, TimeSpan> delayAdjustment = null, CancellationToken cancellationToken = default(CancellationToken)) where T : Attempt
        {
        ...
        /// </summary>
        /// <param name="delayAdjustment">A function that can alter the delay between failed attempts.</param>
        public static IEnumerable<Lazy<T>> DelayWhereFailed<T>(this IEnumerable<Lazy<T>> lazyAttempts, double milliseconds, Func<double, double> delayAdjustment = null, CancellationToken cancellationToken = default(CancellationToken)) where T : Attempt
        {
        ...
        public static Attempts<T> ThrowIfCantSucceed<T>(this IEnumerable<Lazy<T>> lazyAttempts, string message = null, int? maxRetainedAttempts = null) where T : Attempt
        {
            var attempts = lazyAttempts.Execute(maxRetainedAttempts);
            if (!attempts.Succeeded) attempts.BuildException(message);
            return attempts;
        }
        ...
        public static Attempts<T> Execute<T>(this IEnumerable<Lazy<T>> lazyAttempts, int? maxReturnAttempts = null) where T : Attempt
        {
        ...
        /// </summary>
        public static IEnumerable<T> TakeForDuration<T>(this IEnumerable<T> source, TimeSpan duration, CancellationToken cancellationToken = default (CancellationToken))
        {
        ...
        /// Causes iteration to halt after the specified time period has elapsed.
        /// </summary>
        public static IEnumerable<T> TakeForDuration<T>(this IEnumerable<T> source, double milliseconds, CancellationToken cancellationToken = default (CancellationToken))
        {
        ...
        /// </summary>
        public static IEnumerable<Lazy<T>> ThrowWhere<T>(this IEnumerable<Lazy<T>> lazyAttempts, Func<T, bool> predicate) where T : Attempt
        {
        ...
        /// </summary>
        public static IEnumerable<Lazy<T>> CatchWhere<T>(this IEnumerable<Lazy<T>> attempts, Func<T, bool> predicate) where T : Attempt
        {
        ...
        /// </summary>
        public static IEnumerable<Lazy<T>> UsingStrategy<T>(this IEnumerable<Lazy<T>> lazyAttempts, IRetryStrategy strategy, CancellationToken cancellationToken) where T : Attempt
        {
        ...
        /// </summary>
        /// <param name="default">The result value when not successful.</param>
        public static IEnumerable<Lazy<Attempt<T>>> Get<T>(this IRetryStrategy retryStrategy, Func<T> factory, T @default = default(T), CancellationToken cancellationToken = default(CancellationToken))
        {
            return Repeatedly.Get(factory, @default).UsingStrategy(retryStrategy, cancellationToken);
        }

        /// <summary>
        /// Repeatedly yields a lazy invocation attempt of the action as an enumerable.
        /// </summary>
        public static IEnumerable<Lazy<Attempt>> Do(this IRetryStrategy retryStrategy, Action action, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Repeatedly.Do(action).UsingStrategy(retryStrategy, cancellationToken);
        }

    }

    internal class Attempts<T> : IEnumerable<T> where T : TryTo.Attempt
    {
    ...
    internal sealed class RepeatedFailureException<T> : RepeatedFailureException where T : TryTo.Attempt
    {
